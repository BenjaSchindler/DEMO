  ...
  return (
    ...
    <div className='grid grid-cols-4 bg-white h-full w-full'>
      ...
      <div className='row-span-6 col-span-4'>
        <div className='grid grid-cols-1 gap-4 px-5 pb-3 sm:grid-cols-4'>
        {CardData?.length > 0 ? (
              <>
      ...
      <div className='col-span-4 row-span-2 py-3'>
        <div className='grid grid-cols-1 gap-4 px-5 pb-3 sm:grid-cols-4'>
          <ClassCard title={'Te de Hierbas'} img={'https://i.imgur.com/Y2hBPKj.png'} info={'Estas preparaciones a base de hierbas silvestres proporcionan diversos beneficios para nuestra salud. La naturaleza pone a nuestra disposición un gran abanico que, si se saben usar, pueden aportar más de una alegría a nuestro organismo'}/>
